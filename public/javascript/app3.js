jQuery(($) => {
        ...
        $.ajax({
            ...
            $(document).on("click", '#tyler', () => {
                ...
                // hiding question page and showing API page
                    ...
                    $("#page3").hide();
                    $("#poster").append(image);
                    $("#answerHead").append("You're Right! The Critic's Score is " + rotTom);
                    ...
                    // hiding question page and showing API page
                        ...
                        $("#answerHead").append("Sorry! The Critic's Score is " + rotTom);
    ...
    var $dvdBrDiv = $('<div>').addClass("disc").css({ "font-size": "1" });
    ...
    //for (var j = 0; j < films.length; j++) {
        ...
        $.ajax({
            ...
            var $cart = $('<a>').attr("href", addtoCart).attr("target", "_blank").text("Interested in Purchasing this Movie? Click Here!");
